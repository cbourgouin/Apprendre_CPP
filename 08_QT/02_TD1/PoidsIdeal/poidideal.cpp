#include "poidideal.h"
#include "ui_poidideal.h"

PoidIdeal::PoidIdeal(QWidget *parent)
    : QWidget(parent)
    , ui(new Ui::PoidIdeal)
{
    ui->setupUi(this);
...
void PoidIdeal::on_pushButtonSuite_clicked()
{
...
void PoidIdeal::on_pushButtonDev_clicked()
{
    double poidsIdeal = 0;
...
void PoidIdeal::on_pushButtonLor_clicked()
{
    double poidsIdeal = 0;
    if (ui->radioButtonFemme->isChecked()) {
...
void PoidIdeal::on_pushButtonLorAge_clicked()
{
    double poidsIdeal = 0;
        poidsIdeal = ( taille * 100 - 150 ) / 4 + ( age - 20 ) / 4 ;
    if (poidsIdeal > 0) {
